            ...
            <div class="section__content section__content--p35">
                <div class="header3-wrap">
                    ...
                    <div class="header__navbar">
                        <ul class="list-unstyled">
                                ...
                                <a href="">
                                    ...
                                    <li>
                                        <?php if($_SESSION['role']=='superadmin'){
                                            echo '<a href="form.php">form akun</a>';
                                        }else{
                                            echo '';
                                        } ?>
                                    ...
                                    <li>
                                     ...
                                     <li>
                                        <a href="formmainevent2.php">form main event 2</a>
                                    </li>
                                    <li>
                                        <a href="formgallery.php">form gallery</a>
                                    </li>
                                     <li>
                            ...
                            <li class="has-sub">
                                ...
                                <ul class="header3-sub-list list-unstyled">
                                    <li>
                                        <a href="doa.php">form doa</a>
                                    </li>
                                    <li>
                                        <a href="pesan.php">komentar</a>
                                    </li>
                    ...
                    <div class="header__tool">
                            ...
                            <label class="has-sub" style="font-size: 15px;"> Welcome   <?php echo $user_name; ?> ! </label>

                            </div>
                        <div class="account-wrap">
                            <div class="account-item account-item--style2 clearfix js-item-menu">
                                <div class="image">
                                    <img src="images/icon/orang.png" alt="John Doe" />
                                </div>
                                <div class="content">
