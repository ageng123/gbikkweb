                                ...
                                <div class="table-data__tool-left">
                                    ...
                                    <div class="rs-select2--light rs-select2--md">
                                        ...
                                        <select class="js-select2" name="property">
                                            ...
                                            <!-- menampilkan daftar isi table -->
													
											     <?php
            $query_mysql = mysqli_query($db_link, "SELECT * FROM information_schema.tables where table_schema='gbikk'");
            while($data = mysqli_fetch_array($query_mysql, MYSQLI_ASSOC)){
            ?>
                                            <option value=""><?php echo $data['TABLE_NAME'];?></option>
                                            <
                                         <?php } ?>
                                        </select>
